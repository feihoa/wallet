          ...
          <div class="bill__card-content card-content white-text">
            <p v-for="cur of currencies" :key="cur" class="currency-line">
              <span>
                ...
                <input
                  class="bill__input white-text"
                  type="number"
                  v-model.number="amount[cur]"
                  id="val"
                ...
                <div class="bill__btns">
                  ...
                  >
                    <i
                      style="line-height: 0px; vertical-align: text-top"
  ...
  methods: {
    updateAmount() {
      this.totalAmount = Math.floor(
        this.base.BTC * this.currency.bitcoin.usd +
          this.base.ETH * this.currency.ethereum.usd +
          this.base.USD * this.currency.usd.usd
      );
