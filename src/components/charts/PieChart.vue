        ...
        datasets: [
          {
            ...
            borderWidth: 1,
            data: [
              ((this.data.USD / this.data.totalAmount) * 100).toFixed(2),
              ((this.data.BTC / this.data.totalAmount) * 100).toFixed(2),
              ((this.data.ETH / this.data.totalAmount) * 100).toFixed(2),
            ],
          },
        ],
      };
